        ...
        <div className="card-premium">
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-sm leading-relaxed">
            ...
            <section>
              ...
              <p>
                The VItalEdge dosage calculator is an educational tool provided for reference purposes only. It does not provide medical advice, diagnosis, or treatment recommendations. Any dosage calculations are for research reference and should not be interpreted as guidance for human use. Always consult with qualified professionals for any health-related decisions.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                All purchases are processed through Stripe, a third-party payment processor. By making a purchase, you agree to Stripe's terms of service. Prices are subject to change without notice. We reserve the right to refuse or cancel any order for any reason.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                All content on this Site, including text, graphics, logos, tools, and software, is the property of VItalEdge and is protected by applicable intellectual property laws. You may not reproduce, distribute, or create derivative works without our express written permission.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                VItalEdge shall not be liable for any direct, indirect, incidental, special, or consequential damages resulting from the use or inability to use the Site or its products. This includes, but is not limited to, damages for loss of data, profits, or research outcomes.
              </p>
            </section>
